...
class ViewAllMessagesScreen extends StatefulWidget {
  final bool isGroup;
  final int? idEquipe;
  final int? idUser;
  final VoidCallback onUpdateMessages;
  const ViewAllMessagesScreen({
    super.key,
  ...
  @override
  State<ViewAllMessagesScreen> createState() => _ViewAllMessagesScreenState();
}

class _ViewAllMessagesScreenState extends State<ViewAllMessagesScreen> {
      ...
      try {
        ...
        if (widget.isGroup) {
          await messageService.sendMessage(
            receiversId: [],
            message: selectedMessage!,
            idEquipe: widget.idEquipe,
          );
        } else {
          await messageService.sendMessage(
            receiversId: [widget.idUser],
            message: selectedMessage!,
            idEquipe: null,
          );
        }
