...
import 'package:gark_academy/screens/coach/events/coach_event_details_screen.dart';
import 'package:gark_academy/screens/coach/events/coach_training_details_screen.dart';
      ...
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(builder: (context) {
            return CoachEventDetailsScreen(event: event);
          }),
        ).then((_) {
          fetchEventsAndTrainings();
        });
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/icones/double_arrow_white.png",
                fit: BoxFit.cover,
              ),
            )
          ],
    ...
    return Bounceable(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) {
            return CoachTrainingDetailsScreen(training: training);
          }),
        ).then((_) {
          fetchEventsAndTrainings();
        });
